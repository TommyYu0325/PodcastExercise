...
public class ItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * 设置全幅Item(banner)，不設邊界
     */
    private boolean wholeItemNoBorder = false;
...
//        Log.e(TAG, "getItemOffsets: "+childCount+"$"+spanCount+"$"+itemPosition );
        ...
        if(isLinearLayoutManager){
            ...
            if(orientation==VERTICAL_LIST){
                if(drawBorderLeftAndRight){
                    if (wholeItemNoBorder && spanSize == spanCount) {
...
//                }
    ...
    public void setWholeItemNoBorder(boolean wholeItemNoBorder) {
        this.wholeItemNoBorder = wholeItemNoBorder;
    }
